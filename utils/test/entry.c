...
int main() {
    ...
    GcladosTestSuite gcladosTestSuite0 = gcladosCreateTestSuite("./fileExists.test.c", gcladosTests0, 2);
    ...
    GcladosTestSuite gcladosTestSuite1 = gcladosCreateTestSuite("./isStrongPassword.test.c", gcladosTests1, 6);
    GcladosTest gcladosTests2[] = {
        __gcladosTest_nullify_stirng_1("Should nullify the rest of the string"),
    };
    GcladosTestSuite gcladosTestSuite2 = gcladosCreateTestSuite("./nullifyString.test.c", gcladosTests2, 1);
